...
Appointment.create!( appointment: "2019-03-18", users: User.where(id: 2))
Appointment.create!( appointment: "2019-03-19", users: User.where(id: 3))
Appointment.create!( appointment: "2019-03-20", users: User.where(id: 2))
Appointment.create!( appointment: "2019-03-21", users: User.where(id: 3))
Appointment.create!( appointment: "2019-03-22", users: User.where(id: 2))

a = Appointment.find_by(appointment: "2019-03-22")
a.users << User.find_by(id: 3)